...
INSERT INTO PEDIDO (CLIENTE_ID, RESTAURANTE_ID, FORMA_PAGAMENTO_ID, ENDERECO_CEP, ENDERECO_COMPLEMENTO, ENDERECO_LOGRADOURO,
                    ENDERECO_NUMERO, ENDERECO_BAIRRO, TAXA_FRETE, VALOR_TOTAL, STATUS, DATA_CRIACAO, DATA_CONFIRMACAO, DATA_ENTREGA)
VALUES (2, 1, 1, '00000-000', 'Comercio', 'Rua Xyz', '123', 'Centro', 10, 22, 'CRIADO', systimestamp, systimestamp, systimestamp);

INSERT INTO PEDIDO (CLIENTE_ID, RESTAURANTE_ID, FORMA_PAGAMENTO_ID, ENDERECO_CEP, ENDERECO_COMPLEMENTO, ENDERECO_LOGRADOURO,
                    ENDERECO_NUMERO, ENDERECO_BAIRRO, TAXA_FRETE, VALOR_TOTAL, STATUS, DATA_CRIACAO, DATA_CONFIRMACAO, DATA_ENTREGA)
VALUES (2, 2, 2, '11111-111', 'Comercio', 'Rua Xyz', '123', 'Centro', 15, 26, 'CRIADO', systimestamp, systimestamp, systimestamp);
